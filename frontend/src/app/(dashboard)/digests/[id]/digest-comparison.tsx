...
interface DigestSenderInfo {
  fromAddress: string;
  fromName: string;
  count: number;
}

function getSenders(digest: Digest): Map<string, DigestSenderInfo> {
  const map = new Map<string, DigestSenderInfo>();
        ...
        {emailDelta !== 0 && (
          <div className="flex items-center gap-2 text-sm">
            ...
            <span>
              ...
              {pluralize(Math.abs(emailDelta), "email")} than last digest
