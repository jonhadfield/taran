...
func TestProcessor_ProcessEmail_Success(t *testing.T) {
	...
	proc := NewProcessor(ProcessorConfig{BufferSize: 10, Concurrency: 1, Emails: emails, Extractions: extractions, Resolver: llm.NewProviderResolver(provider, nil, nil, nil)})
...
func TestProcessor_ProcessEmail_LLMError(t *testing.T) {
	...
	proc := NewProcessor(ProcessorConfig{BufferSize: 10, Concurrency: 1, Emails: emails, Extractions: &testutil.MockExtractionRepo{}, Resolver: llm.NewProviderResolver(provider, nil, nil, nil)})
...
func TestProcessor_ProcessEmail_NoContent(t *testing.T) {
	...
	proc := NewProcessor(ProcessorConfig{BufferSize: 10, Concurrency: 1, Emails: emails, Extractions: &testutil.MockExtractionRepo{}, Resolver: llm.NewProviderResolver(&testutil.MockProvider{}, nil, nil, nil)})
	proc.Start(context.Background())
...
func TestProcessor_Enqueue_QueueFull(t *testing.T) {
	...
	proc := NewProcessor(ProcessorConfig{BufferSize: 1, Concurrency: 1, Emails: emails, Extractions: &testutil.MockExtractionRepo{}, Resolver: llm.NewProviderResolver(&testutil.MockProvider{}, nil, nil, nil)})
...
func TestProcessor_ConcurrentProcessing(t *testing.T) {
	...
	proc := NewProcessor(ProcessorConfig{BufferSize: 10, Concurrency: 2, Emails: emails, Extractions: &testutil.MockExtractionRepo{}, Resolver: llm.NewProviderResolver(provider, nil, nil, nil)})
	proc.Start(context.Background())
