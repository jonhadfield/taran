...
func TestProcessor_ProcessEmail_Success(t *testing.T) {
	...
	proc := NewProcessor(10, 1, emails, extractions, llm.NewProviderResolver(provider, nil, nil, nil), nil, nil, nil)
...
func TestProcessor_ProcessEmail_LLMError(t *testing.T) {
	...
	proc := NewProcessor(10, 1, emails, &testutil.MockExtractionRepo{}, llm.NewProviderResolver(provider, nil, nil, nil), nil, nil, nil)
...
func TestProcessor_ProcessEmail_NoContent(t *testing.T) {
	...
	proc := NewProcessor(10, 1, emails, &testutil.MockExtractionRepo{}, llm.NewProviderResolver(&testutil.MockProvider{}, nil, nil, nil), nil, nil, nil)
	proc.Start(context.Background())
...
func TestProcessor_Enqueue_QueueFull(t *testing.T) {
	...
	proc := NewProcessor(1, 1, emails, &testutil.MockExtractionRepo{}, llm.NewProviderResolver(&testutil.MockProvider{}, nil, nil, nil), nil, nil, nil)
...
func TestProcessor_ConcurrentProcessing(t *testing.T) {
	...
	proc := NewProcessor(10, 2, emails, &testutil.MockExtractionRepo{}, llm.NewProviderResolver(provider, nil, nil, nil), nil, nil, nil)
	proc.Start(context.Background())
