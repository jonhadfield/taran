...
func TestProcessor_ProcessEmail_Success(t *testing.T) {
	...
	proc := NewProcessor(10, 1, emails, extractions, provider, nil, nil)
...
func TestProcessor_ProcessEmail_LLMError(t *testing.T) {
	...
	proc := NewProcessor(10, 1, emails, &testutil.MockExtractionRepo{}, provider, nil, nil)
...
func TestProcessor_ProcessEmail_NoContent(t *testing.T) {
	...
	proc := NewProcessor(10, 1, emails, &testutil.MockExtractionRepo{}, &testutil.MockProvider{}, nil, nil)
	proc.Start(context.Background())
...
func TestProcessor_Enqueue_QueueFull(t *testing.T) {
	...
	proc := NewProcessor(1, 1, emails, &testutil.MockExtractionRepo{}, &testutil.MockProvider{}, nil, nil)
...
func TestProcessor_ConcurrentProcessing(t *testing.T) {
	...
	proc := NewProcessor(10, 2, emails, &testutil.MockExtractionRepo{}, provider, nil, nil)
	proc.Start(context.Background())
